"""keysbnb_25068 URL Configuration
...
admin.site.site_header = "KeysBnB"
admin.site.site_title = "KeysBnB Admin Portal"
admin.site.index_title = "KeysBnB Admin"

# swagger
api_info = openapi.Info(
    title="KeysBnB API",
    default_version="v1",
    description="API documentation for KeysBnB App",
)
